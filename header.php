...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', '42draconis_v0_1' ); ?></a>
    <?php if (!$hideHeader) { ?>
    <header class="u-clearfix u-header u-header" id="sec-ee2a">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'link_class' => 'u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-grey-50',
                    'link_style' => 'padding: 10px 20px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-5360-19',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => 'padding: 10px 20px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-5360-20',
                    'submenu_item_class' => 'u-nav-item',
